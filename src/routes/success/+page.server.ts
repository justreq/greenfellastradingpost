...
export const load = (async ({ url, fetch }) => {
	...
	email(customerDetails.email as string, `${isPsa ? "PSA " : ""}Order Processed!`, `<h1>Thank you for shopping with us! We have recieved your order of:</h1>${checkoutContents.data.map((i) => i.description).join("<br>")}.<br><br>${isPsa ? "Whenever you are ready, please ship your cards to this address: 2412 East 65th St, Brooklyn NY 11234. Once we recieve your cards, we will take them straight to the PSA grading bin. We are not in control of how long the grading process takes, but we can assure you that your cards will skip the normal processing times, ensuring faster results. When we recieve your graded cards, we will ship them back to you" : "You will recieve your order soon. Shipping times are not determined by us and can be affected by several factors, but rest assured that we will have your order shipped out in the next few business days"}. If you have any concerns or questions, feel free to reach out to us by email: greenfellastradingpost@gmail.com.`);
